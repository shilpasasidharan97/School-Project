"""
Django settings for schoolmgtsystem project.
...
SECRET_KEY = 'django-insecure-9&ug+#xm-_^mq)ufr1*h-n%x1%)s-xo_$l#834m&t1(94u0=qx'
...
ROOT_URLCONF = 'schoolmgtsystem.urls'
...
WSGI_APPLICATION = 'schoolmgtsystem.wsgi.application'
